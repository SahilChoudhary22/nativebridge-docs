...
<CardGroup cols={2}>
  <Card title="VS Code Extension" icon="visual-studio" href="/tools/vscode">
    Direct debugging from Visual Studio Code
  </Card>

  <Card title="Android Studio Plugin" icon="android" href="/tools/android-studio">
    Seamless integration with Android Studio
  </Card>

  <Card title="Xcode Integration" icon="apple" href="/tools/xcode">
    iOS debugging through Xcode workflows
  </Card>

  <Card title="IntelliJ Plugin" icon="intellij" href="/tools/intellij">
    Full debugging support in IntelliJ IDEA
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="API Documentation" icon="book" href="/api/debugging">
    Programmatic access to debugging tools
  </Card>

  <Card title="Video Tutorials" icon="video" href="/tutorials/debugging">
    Step-by-step debugging walkthroughs
  </Card>

  <Card title="Knowledge Base" icon="lightbulb" href="/kb/debugging">
    Common debugging scenarios and solutions
  </Card>

  <Card title="Support" icon="headset" href="/support">
    Get expert help with debugging issues
  </Card>
</CardGroup>
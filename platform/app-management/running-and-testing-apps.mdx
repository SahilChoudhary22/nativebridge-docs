...
<Frame>
  <img src="/images/app-page-overview.png" alt="NativeBridge App Page - What users see when clicking a magic link" />
</Frame>
...
### Device & OS Selection
* Wide range of [supported devices and OS versions](/features/devices-and-os-versions)
...
* **[UI Automation (AppRecorder)](/features/ui-automation)** - Record and replay user interactions
* **[Network Traffic Monitor](/features/network-traffic-monitor)** - Inspect all network requests and responses
* **[Debug Logs](/features/debug-logs)** - View console and system logs in real-time
* **[ADB Tunnel](/features/advanced-features/android/adb-tunnel)** - Direct ADB access (Android only)
...
<Steps>
  <Step title="Navigate to Apps Dashboard">
    Go to your [Apps Dashboard](https://nativebridge.io/apps)
  </Step>
...
1. Navigate to your [Apps page](https://nativebridge.io/apps)
...
<CardGroup cols={2}>
  <Card title="Debugging Features" icon="bug" href="/features/debugging">
    Learn about advanced debugging tools
  </Card>

  <Card title="Test Automation" icon="robot" href="/platform/test-automation">
    Set up automated testing workflows
  </Card>

  <Card title="Share Your App" icon="share" href="/platform/sharing-apps">
    Create magic links for stakeholders
  </Card>

  <Card title="API Integration" icon="code" href="/rest-api">
